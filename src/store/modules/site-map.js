  ...
  about: {
    ...
    subclass: {
      ...
      contact: {
        'zh-TW': {
          title: '聯絡我們',
          detail: ['提供自行開車、', '搭乘火車', '及高鐵三種不同的交通資訊']
        },
        'en-US': {
          title: 'Contact Us',
  ...
  research: {
    ...
    subclass: {
      ...
      researchGroup: {
        ...
        href: '/research/researchGroup'
      },
      center: {
        'zh-TW': {
          title: '研究中心',
          detail: ['成功大學資訊系', '相關研究中心']
        },
        'en-US': {
          title: 'Center',
  ...
  getEntryByTopic: state => {
    return (obj) => {
      return Object.keys(state[obj.topic].subclass).map(key => {
        ...
        return {
          title: entry[obj.language].title,
          detail: entry[obj.language].detail,
          href: (entry.href[0] === '/') ? `${entry.href}?languageId=${obj.languageId}` : entry.href
        }
      })
    }
  }
